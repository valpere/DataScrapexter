...
sub load_historical_data {
    ...
    } ## end sub process_history_file
} ## end sub load_historical_data
...
sub identify_new_products {
    ...
    } ## end foreach my $product (@$current_products)
} ## end sub identify_new_products
...
sub scrape_new_products {
    ...
    } ## end foreach my $product (@new_products)

    print "\nScraping complete: $successful successful, $failed failed\n";
} ## end sub scrape_new_products
